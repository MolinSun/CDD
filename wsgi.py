...
def custom_static(filename):
    ...
    return send_from_directory('/home/ubuntu/PersonalProject/BackEnd/upload/', filename)
# --------------------------

@app.route('/movie/<path:filename>')
def custom_static_movie(filename):
    print('#'*20, filename, ' in custom_static',app.root_path)
    return send_from_directory('/home/ubuntu/PersonalProject/BackEnd/movie/', filename)

if __name__ == "__main__":
    db.create_all()

    app.run(host="ec2-54-194-67-198.eu-west-1.compute.amazonaws.com", port=5000, threaded=False)
